+++
title = "An Automatic Security Camera Lens Cleaner"
...
{{< figure src="/ox-hugo/security_camera_lens_cleaner.jpg" caption="<span class=\"figure-number\">Figure 1: </span>The system had a compressor from an electric bicycle tire pump (left), a control valve (center) to activate the quick-emission valve (right) to push a burst of air through a hose onto the camera's lens." >}}
...
<iframe width=560 height=315 src="https://www.youtube.com/embed/nzDOJuoSqGU" frameborder="0" allowfullscreen></iframe>
